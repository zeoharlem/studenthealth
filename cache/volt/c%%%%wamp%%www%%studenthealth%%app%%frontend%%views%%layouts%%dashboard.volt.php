									...
									<div class="tbl info-tbl">
										<div class="tbl-row">
											...
											<div class="tbl-cell tbl-cell-stat">
												<a href="<?= $this->url->get('dashboard/') ?>" class="btn btn-primary">DASHBOARD</a>
											</div>
											<div class="tbl-cell tbl-cell-stat">
			...
			<div class="row">
					...
					<aside class="profile-side">
						<section class="box-typical profile-side-user">
							<button type="button" class="avatar-preview avatar-preview-128">
								<img src="<?= $this->url->get('assets/main/uploads/' . $dataStage->imagecaption->image_url) ?>" alt=""/>
								<span class="update">
									<i class="font-icon font-icon-picture-double"></i>
									Update photo
								</span>
							...
							<div class="bottom-txt"><?= ucwords($this->session->get('auth')['fullname']) ?></div>
						</section>
				...
				<div class="col-xl-9 col-lg-8">
					<section class="tabs-section">
						<?= $this->partial('partials/headerview') ?>
