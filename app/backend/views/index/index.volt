...
<head>
  ...
  <link rel="apple-touch-icon" href="../../salesapp/assets/images/apple-touch-icon.png">
  <link rel="shortcut icon" href="../../salesapp/assets/images/favicon.ico">

  <!-- Stylesheets -->
  <link rel="stylesheet" href="../../salesapp/assets/css/bootstrap.min.css">
  <link rel="stylesheet" href="../../salesapp/assets/css/bootstrap-extend.min.css">
  <link rel="stylesheet" href="../../salesapp/assets/css/site.min.css">

  <link rel="stylesheet" href="../../salesapp/assets/vendor/animsition/animsition.css">
  <link rel="stylesheet" href="../../salesapp/assets/vendor/asscrollable/asScrollable.css">
  <link rel="stylesheet" href="../../salesapp/assets/vendor/switchery/switchery.css">
  <link rel="stylesheet" href="../../salesapp/assets/vendor/intro-js/introjs.css">
  <link rel="stylesheet" href="../../salesapp/assets/vendor/slidepanel/slidePanel.css">
  <link rel="stylesheet" href="../../salesapp/assets/vendor/flag-icon-css/flag-icon.css">


  <!-- Fonts -->
  <link rel="stylesheet" href="../../salesapp/assets/fonts/web-icons/web-icons.min.css">
  <link rel="stylesheet" href="../../salesapp/assets/fonts/brand-icons/brand-icons.min.css">
  <link rel='stylesheet' href='http://fonts.googleapis.com/css?family=Roboto:300,400,500,300italic'>


  <!--[if lt IE 9]>
    <script src="../../salesapp/assets/vendor/html5shiv/html5shiv.min.js"></script>
    <![endif]-->

  <!--[if lt IE 10]>
    <script src="../../salesapp/assets/vendor/media-match/media.match.min.js"></script>
    <script src="../../salesapp/assets/vendor/respond/respond.min.js"></script>
    <![endif]-->

  <!-- Scripts -->
  <script src="../../salesapp/assets/vendor/modernizr/modernizr.js"></script>
  <script src="../../salesapp/assets/vendor/breakpoints/breakpoints.js"></script>
  <script>
    Breakpoints();
  </script>
</head>
<body>
  ...
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
        <img class="navbar-brand-logo" src="../../salesapp/assets/images/logo.png" title="Remark">
                      ...
                      <ul class="blocks-3">
                        <li>
                          <a class="thumbnail margin-0" href="javascript:void(0)">
                            <img class="width-full" src="../../salesapp/assets/photos/placeholder.png" alt="..." />
                          </a>
                        </li>
                        <li>
                          <a class="thumbnail margin-0" href="javascript:void(0)">
          ...
          <li class="dropdown">
            ...
            data-animation="slide-bottom" role="button">
              <span class="avatar avatar-online">
                <img src="../../salesapp/assets/portraits/5.jpg" alt="...">
                <i></i>
              </span>
            </a>
            <ul class="dropdown-menu" role="menu">
                      ...
                      <div class="media">
                        <div class="media-left padding-right-10">
                          <span class="avatar avatar-sm avatar-online">
                            <img src="../../salesapp/assets/portraits/2.jpg" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left padding-right-10">
                          <span class="avatar avatar-sm avatar-busy">
                            <img src="../../salesapp/assets/portraits/4.jpg" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
            ...
            <li class="site-menu-item has-sub active open">
              ...
              <ul class="site-menu-sub">
                ...
                <li class="site-menu-item active">
                  <a class="animsition-link" href="blank.html" data-slug="layout-blank">
                    <i class="site-menu-icon " aria-hidden="true"></i>
  ...
  <!-- Core  -->
  <script src="../../salesapp/assets/vendor/jquery/jquery.js"></script>
  <script src="../../salesapp/assets/vendor/bootstrap/bootstrap.js"></script>
  <script src="../../salesapp/assets/vendor/animsition/jquery.animsition.js"></script>
  <script src="../../salesapp/assets/vendor/asscroll/jquery-asScroll.js"></script>
  <script src="../../salesapp/assets/vendor/mousewheel/jquery.mousewheel.js"></script>
  <script src="../../salesapp/assets/vendor/asscrollable/jquery.asScrollable.all.js"></script>
  <script src="../../salesapp/assets/vendor/ashoverscroll/jquery-asHoverScroll.js"></script>

  <!-- Plugins -->
  <script src="../../salesapp/assets/vendor/switchery/switchery.min.js"></script>
  <script src="../../salesapp/assets/vendor/intro-js/intro.js"></script>
  <script src="../../salesapp/assets/vendor/screenfull/screenfull.js"></script>
  <script src="../../salesapp/assets/vendor/slidepanel/jquery-slidePanel.js"></script>


  <!-- Scripts -->
  <script src="../../salesapp/assets/js/core.js"></script>
  <script src="../../salesapp/assets/js/site.js"></script>

  <script src="../../salesapp/assets/js/sections/menu.js"></script>
  <script src="../../salesapp/assets/js/sections/menubar.js"></script>
  <script src="../../salesapp/assets/js/sections/sidebar.js"></script>

  <script src="../../salesapp/assets/js/configs/config-colors.js"></script>
  <script src="../../salesapp/assets/js/configs/config-tour.js"></script>

  <script src="../../salesapp/assets/js/components/asscrollable.js"></script>
  <script src="../../salesapp/assets/js/components/animsition.js"></script>
  <script src="../../salesapp/assets/js/components/slidepanel.js"></script>
  <script src="../../salesapp/assets/js/components/switchery.js"></script>
