        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="assets/img/logo.png" data-dark-src="assets/img/logo_dark.png" class="logo">
                </a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    <input type="text" name="phonenumber" class="form-control input-lg" placeholder="Phone Number" required >
                </div>
                <div class="form-group">
                    <input type="text" name="address" class="form-control input-lg" placeholder="Home Address" required >
                </div>
                
                <div class="form-group">
                    <input type="email" name="email" class="form-control input-lg" placeholder="E-mail address" required >
                </div>
                <div class="form-group">
                    <input type="password" name="password" class="form-control input-lg" placeholder="Password" required>
                </div>
                
                <button class="btn btn-lg btn-primary btn-block" type="submit">REGISTER NOW</button><br>
                Already have an account? <a href="{{url('index/')}}">Sign In</a> Now!
              </form>
            </div>
        </div>
      </div>	</div>
