{% block content %}
    <div role="tabpanel" class="tab-pane active" id="tabs-2-tab-1">
        <form class="box-typical" id="stage-1" method="post">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                                <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInput" value="{{dataStage ? dataStage.surname:''}}" name="surname" placeholder="Enter your surname">
                        ...
                        <div class="col-lg-6">
                                <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="othernames" value="{{session.get('auth')['fullname']}}" id="exampleInputEmail1" placeholder="Type other names">
                                </fieldset>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                                <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Telephone Number" value="{{session.get('auth')['phonenumber']}}"  name="phone_number">
                                </fieldset>
                        </div>
                        ...
                        <div class="tbl">
                                <div class="tbl-row">
                                        ...
                                        <div class="tbl-cell tbl-cell-action">
                                                <button type="submit" id="stage-1" class="btn btn-rounded">Submit</button>
                                        </div>
                                </div>
                        </div>
                </div>
