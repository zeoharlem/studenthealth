                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="{{url('assets/main/uploads/'~session.get('auth')['dataImage'])}}" />
                                    <span class="username username-hide-on-mobile"> {{session.get('auth')['fullname'] | capitalize}} </span>
